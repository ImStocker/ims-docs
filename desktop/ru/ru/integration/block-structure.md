...
Все значения свойств внутри `props`, `inherited` и `computed` строго типизированы. Поддерживаются следующие типы (перечисление `AssetPropType`): [Описание типа (`AssetPropValueType`)](#описание-типа-assetpropvaluetype)
