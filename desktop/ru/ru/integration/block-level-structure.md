...
| Поле в params |         Тип        |                  Описание                  |
|:-------------:|:------------------:|:------------------------------------------:|
| file          | AssetPropValueFile | Структура прикреплённого файла [см. раздел Структура отдельного блока](../integration/block-structure.md#прикреплённый-файл) |
...
|             Поле            |         Тип         |                Описание                |
|:---------------------------:|:-------------------:|:--------------------------------------:|
| value                       | AssetPropValueAsset |[см. раздел Структура отдельного блока](../integration/block-structure.md#ссылка-на-элемент)|
| scaleX, scaleY              | number(опционально) | Масштаб отображения                    |
